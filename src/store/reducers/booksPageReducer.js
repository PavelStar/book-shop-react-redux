...
export const booksToPageAction = (payload) => ({ type: BOOKS_TO_PAGE, payload })
export const isPageLoadingAction = (payload) => ({ type: IS_PAGE_LOADING, payload })
export const searchTypeAction = (payload) => ({ type: SEARCH_TYPE, payload })
export const clickOnAuthorAction = (payload) => ({ type: CLICK_ON_AUTHOR, payload })
export const searchByGenreAction = (payload) => ({ type: SEARCH_BY_GENRE, payload })