...
export const responseItemsAction = (payload) => ({
    type: RESPONSE_ITEMS,
    payload,
});
export const snippetsItemsAction = (payload) => ({
    type: SNIPPETS_ITEMS,
    payload,
});
export const getFullBookInfoAction = (payload) => ({
    type: GET_FULL_BOOK_INFO,
    payload,
});
export const showSnippetsAction = (payload) => ({
    type: SHOW_SNIPPETS,
    payload,
});
...
export const btnClickLoadingAction = (payload) => ({
    type: BTN_CLICK_LOAD,
    payload,
});
export const isSnippetsOpenAction = (payload) => ({
    type: IS_SNIPPETS_OPEN,
    payload,
});
