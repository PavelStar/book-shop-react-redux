...
import { cartItemsAction, isItemDeletedAction, deletedItemIdAction, priceSumAction, clearCartAction, myOrdersAction, successOrderAction, orderNumAction } from '../../store/reducers/cartReducer'
import './Cart.scss'
...
const Cart = () => {
    ...
    // const orderNum = useSelector(state => state.cartReducer.orderNum)
    ...
    const addToMyOrders = () => {
        ...
        // dispatch(myOrdersAction(cartItems))
    }
    ...
    return (
        <div className="cart">
            <a onClick={() => setIsCartOpen(true)} className="cart__inner">
                <div className="cart__icon-wrap">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.68104 25C10.1639 25 11.366 23.7979 11.366 22.3151C11.366 20.8322 10.1639 19.6301 8.68104 19.6301C7.19818 19.6301 5.99609 20.8322 5.99609 22.3151C5.99609 23.7979 7.19818 25 8.68104 25Z" fill="#F89345" />
                        <path d="M20.0175 25C21.5003 25 22.7024 23.7979 22.7024 22.3151C22.7024 20.8322 21.5003 19.6301 20.0175 19.6301C18.5346 19.6301 17.3325 20.8322 17.3325 22.3151C17.3325 23.7979 18.5346 25 20.0175 25Z" fill="#F89345" />
                        <path d="M8.69836 4.71566C7.42018 4.69656 6.2945 3.8696 5.89413 2.65559L5.63817 1.87946C5.27003 0.770822 4.24054 0.0166738 3.07251 0H1.07371C0.744175 0 0.477051 0.267124 0.477051 0.59666C0.477051 0.926197 0.744175 1.19332 1.07371 1.19332H3.07251C3.72125 1.20765 4.2925 1.62421 4.50452 2.23749L8.03324 12.9636C8.18208 13.416 8.16855 13.9061 7.995 14.3497C7.66787 15.205 7.75603 16.1637 8.23369 16.9451C8.7302 17.7031 9.56549 18.1709 10.4712 18.1981H22.106C22.4356 18.1981 22.7027 17.931 22.7027 17.6014C22.7027 17.2719 22.4356 17.0048 22.106 17.0048H10.4711C9.9688 16.9874 9.50901 16.7183 9.248 16.2888C8.96637 15.8649 8.91064 15.3297 9.09885 14.8568L9.45682 13.9618C9.5075 13.827 9.51966 13.6811 9.49214 13.5401C9.48876 13.5228 9.48334 13.506 9.4768 13.4897C9.39199 13.2777 9.5336 13.0434 9.76074 13.02L21.4496 11.8137C22.3337 11.7342 23.0672 11.0969 23.2694 10.2326L23.6595 8.58863C24.1025 6.722 22.7037 4.925 20.7854 4.89633L8.69836 4.71566Z" fill="#F89345" />
                    </svg>
                    {
                        cartItems.length
                            ?
...

            {
                isCartOpen
                    ?
                    <div onClick={hideOnOverlay} ref={overlayRef} className="cart__overlay">
                        <div className="cart__popup">
                            <div className="cart__popup-header">
                                <h2 className="cart__title">Корзина</h2>
                                <button onClick={() => setIsCartOpen(false)} className="cart__close-btn">Скрыть корзину</button>
                            </div>
                            <ul className="cart__items-list">

                                {
                                    cartItems && !successOrder
                                    &&
                                    cartItems.map((item) => {
                                        return (
                                            <li className="cart__item">
                                                ...
                                                <div className="cart__item-info">
                                                    ...
                                                    <p className="cart__item-author">{item.authors}</p>
                                                    <p className="cart__item-type">Электронная книга</p>
                                                    <p className="cart__item-id">Артикул: {item.id}</p>
                                                    <div className="cart__item-counter-wrap">

                                                        <p className="cart__item-price">{item.price} руб.</p>
                                                    </div>
                                                </div>
                                                <button onClick={() => deleteItem(item)} className="cart__item-del-btn">
                                ...
                                }
                                {
                                    ...
                                    <li className="cart__empty">
                                        ...
                                        <a onClick={() => setIsCartOpen(false)} className="cart__back-to-page-btn" href="#">Вернуться на страницу</a>
                                    </li>
                                }
                                {
                                    successOrder
                                    ...
                                    <li className="cart__order-success">
                                        <img src={imgSuccess} alt="success" width="200px"/>
                                        <p>Заказ #{orderNum} оформлен и добавлен в 
                                            <Link onClick={() => setIsCartOpen(false)} to="/history">историю заказов</Link>
                                        </p>
                                    </li>
                                }
...

                            {
                                cartItems.length
                                    ?
                                    <>
                                        <button onClick={clearingCart} className="cart__clear-btn">Очистить корзину</button>
                                        <div className="cart__footer">
                                            <div className="cart__footer-price">
                                                <span>Итого:</span>
                                                <span>{priceSum} руб.</span>
                                            </div>
                                            <button onClick={addToMyOrders} className="cart__apply-btn">Оформить заказ</button>
                                        </div>
                                    </>
                                    :
                                    null
