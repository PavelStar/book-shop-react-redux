                ...
                currentBook
                    ...
                    <div className="book-info__inner">
                        <div className="book-info__img-wrap">
                            <img className="book-info__img" src={currentBook.image} alt={currentBook.title} />

                            <div>
                                <p className="book-info__price">{currentBook.price} руб</p>
                        ...
                        <div className="book-info__info-wrapper">
                            <h3 className="book-info__title">{currentBook.title}</h3>
