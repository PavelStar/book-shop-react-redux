...
const Snippets = () => {
    ...
    const snippetsItems = useSelector(
        (state) => state.responseReducer.snippetsItems,
    );
                            ...
                            >
                                <li className="snippets__item">
                                    <div className="snippets__img-wrapper">
                                        {book.image === null ? (
                                            <div className="snippets__img-empty">
                                                <span></span>
                                            </div>
                                        ) : (
                                            <img
                                                className="snippets__item-img"
                                                src={book.image}
                                                alt={book.title}
                                            />
                                        )}
                                    ...
                                    <div className="snippets__item-inner">
                                        <h3 className="snippets__item-title">
                                            {book.title}
                                        </h3>
                                        <p className="snippets__item-author">
                                            {book.authors}
                                        </p>
                                    </div>
                                </li>
            ...
            {snippetsItems.length ? (
                <div className="snippets__btns-wrap">
                    <Link
                        ...
                        className="snippets__results-btn"
                    >
                        Все результаты
                    </Link>
