...
import {
    btnClickLoadingAction,
    snippetsItemsAction,
} from "../../../store/reducers/responseReducer";
import {
    resTotalItemsAction,
    switchPageAction,
